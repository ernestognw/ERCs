...
By implementing [ERC-7786] compatibility and recommending a standard way to encode the `payload` of the `sendMessage` function, [ERC-7888] systems can integrate with both future cross-chain messaging infrastructure and existing [ERC-7786] infrastructure and tooling, enabling standardized storage proof attributes and cross-protocol communication while maintaining the core [ERC-7888] functionality.
